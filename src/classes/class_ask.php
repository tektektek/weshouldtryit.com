                ...
                //register new session for 2 partners and reply with ask_key
                  //create new user
                   ...
                   if($level_txt == '')
                    ...
                    $query = "INSERT INTO user (date_added,ask_key,username,display_name,levels) VALUES ('$stamp_now','$ask_key','$ask_key','$nick1','$level_txt')"; 
                    $db->query($query);
                    ...
                    $query = "INSERT INTO user (date_added,ask_key,username,display_name,levels) VALUES ('$stamp_now','$ask_key_partner','$ask_key_partner','$nick2','$level_txt')"; 
                    $db->query($query);
